...
@Autonomous
public class CloseBlueAutoWithWhite extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.update();
        TrajectorySequence basic = drive.trajectorySequenceBuilder(new Pose2d(60.00, 12.00, Math.toRadians(180.00)))
                ...
                .build();
        TrajectorySequence toStack = drive.trajectorySequenceBuilder(basic.end())
                .lineToSplineHeading(new Pose2d(36.00, -50.00, Math.toRadians(180.00)))
                .addTemporalMarker(0.5,() -> {
        ...
        drive.followTrajectorySequence(basic);

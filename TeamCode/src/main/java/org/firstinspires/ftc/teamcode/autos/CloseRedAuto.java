...
public class CloseRedAuto extends LinearOpMode {
    ...
    final double[] xpossR = {23.96, 29.96, 35.96};
    final int[] rotsR = {90, 0, 270};
    final double[] spikePlaceX = {0, -1.2, 1.2};
    final double[] spikePlaceY = {4, 6, -1};
    @Override
    public void runOpMode() throws InterruptedException{
        ...
        TrajectorySequence ts = drive.trajectorySequenceBuilder(new Pose2d(60.00, 12.00, Math.toRadians(180.00)))
                .lineToSplineHeading(new Pose2d(xpossR[detection], 56.50, Math.toRadians(90.00))) //ADJUST Y TO YOUR NEEDS (FROM ARMBACKDROP position)
                ...
                .waitSeconds(2)
                .lineToLinearHeading(new Pose2d(30.50 + spikePlaceX[detection], 12.00, Math.toRadians(rotsR[detection])))//PLACE PURPLE: claw on ground, full open, transfer
                .addTemporalMarker(() -> {

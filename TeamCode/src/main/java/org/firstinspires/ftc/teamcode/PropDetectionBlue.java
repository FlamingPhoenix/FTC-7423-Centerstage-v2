...
public class PropDetectionBlue extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        Rect rect1 = new Rect(140, 370, 200, 200);
        Rect rect3 = new Rect(940, 370, 200, 200);
        Rect rect2 = new Rect(580, 380, 130, 150);

        // Draw rectangles on the output frame (plug into the tv so that we can see the boxes)
        ...
        // Calculate the amount of blue in each rectangle
